...
if($event=='web')
echo 'Web Desigining ';
?> Questions (<?php echo $count;?>)</h3></div>
<div class="col-md-6 " >
...
<th>Options</th>
	...
	<?php foreach($participants as $participant): ?>
		...
		<tr>
		<td class="id"><?php echo $participant->id;?></td>
		
		<td class="question"><?php echo $participant->question;?></br><?php if($participant->program!='') {?><pre  class="prettyprint " ><?php  echo $participant->program;}?></pre></td>
			
		<td class="op1"><?php echo $participant->op1;?></td>
		
		<td class="op2"><?php echo $participant->op2;?></td>
		<td class="op3"><?php echo $participant->op3;?></td>
		<td class="op4"><?php echo $participant->op4;?></td>
<td><?php echo $participant->ans;?></td>
<td><?php echo $participant->pts;?></td>

<td><?php echo anchor($event.'/wipeQuestion/'.$participant->id, 'Delete', 'title="Delete"'); ?></td>
...
<script>  
 ...
 //$('#result,#name,#email,#message').empty();
      ...
      if(question!='' && op1!='' && op2!='' && op3!='' && op4!='' && ans!='' && pts!='' )
          ...
          $.post( "<?php echo base_url().$event;?>/updateQuestion/new",{ question:question,program:program ,op1: op1, op2:op2, op3:op3, op4:op4, ans:ans, pts:pts}, function(data) {
              location.reload();
             }
          );
